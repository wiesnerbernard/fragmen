        ...
        <div className="max-w-4xl mx-auto">
          <article
            className="prose prose-neutral dark:prose-invert max-w-none
              prose-headings:font-bold prose-headings:text-foreground prose-h2:text-3xl prose-h2:mt-12 prose-h2:mb-6 prose-h2:border-b prose-h2:border-border prose-h2:pb-2
              prose-h3:text-2xl prose-h3:mt-8 prose-h3:mb-4
              prose-h4:text-lg prose-h4:mt-6 prose-h4:mb-3 prose-h4:text-primary
              prose-p:text-foreground/90 dark:prose-p:text-foreground/95 prose-p:leading-relaxed
              prose-ul:my-4 prose-li:my-1 prose-li:text-foreground/90 dark:prose-li:text-foreground/95
